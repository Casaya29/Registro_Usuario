...
namespace Proyecto_Final.Controllers
{
    ...
    public class LocalidadController : ControllerBase
    {
        ...
        public LocalidadController(DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Localidad>> PostLocalidad(Localidad localidad)
        {
          if (_context.Localidad == null)
          {
              return Problem("Entity set 'DBContext.Localidad'  is null.");
          }
        ...
        {
            return (_context.Localidad?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
